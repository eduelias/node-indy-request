...
async function main() {
  ...
  let toBeOnboarded = nacl.sign.keyPair.fromSeed(
    Buffer.from('00000000000000000000000000000011', 'utf8') // <<-- Change this guy if you want a new transaction
    // Buffer.from ('00000000000000000000000000000002', 'utf8')
  );

  // generate authorized key pairs
  let trustee1 = nacl.sign.keyPair.fromSeed(
    Buffer.from('000000000000000000000000Steward1', 'utf8')
  );
  ...
  let nymTxn = {
    operation: {
      ...
      dest: my1DID,
      role: IndyReq.role.TRUST_ANCHOR,
      verkey: my1Verkey,
    },
